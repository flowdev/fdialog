...
func uidlParserInit() {
	...
	staticData.serializedATN = []int32{
		4, 1, 16, 112, 2, 0, 7, 0, 2, 1, 7, 1, 2, 2, 7, 2, 2, 3, 7, 3, 2, 4, 7,
		...
		8, 10, 12, 14, 16, 0, 1, 2, 0, 11, 11, 13, 13, 123, 0, 19, 1, 0, 0, 0,
		2, 29, 1, 0, 0, 0, 4, 33, 1, 0, 0, 0, 6, 45, 1, 0, 0, 0, 8, 61, 1, 0, 0,
		0, 10, 63, 1, 0, 0, 0, 12, 73, 1, 0, 0, 0, 14, 92, 1, 0, 0, 0, 16, 109,
		1, 0, 0, 0, 18, 20, 5, 16, 0, 0, 19, 18, 1, 0, 0, 0, 19, 20, 1, 0, 0, 0,
		20, 21, 1, 0, 0, 0, 21, 22, 3, 2, 1, 0, 22, 23, 3, 8, 4, 0, 23, 25, 3,
		4, 2, 0, 24, 26, 5, 16, 0, 0, 25, 24, 1, 0, 0, 0, 25, 26, 1, 0, 0, 0, 26,
		27, 1, 0, 0, 0, 27, 28, 5, 0, 0, 1, 28, 1, 1, 0, 0, 0, 29, 30, 5, 1, 0,
		0, 30, 31, 5, 16, 0, 0, 31, 32, 5, 11, 0, 0, 32, 3, 1, 0, 0, 0, 33, 39,
		3, 6, 3, 0, 34, 35, 3, 8, 4, 0, 35, 36, 3, 6, 3, 0, 36, 38, 1, 0, 0, 0,
		37, 34, 1, 0, 0, 0, 38, 41, 1, 0, 0, 0, 39, 37, 1, 0, 0, 0, 39, 40, 1,
		0, 0, 0, 40, 43, 1, 0, 0, 0, 41, 39, 1, 0, 0, 0, 42, 44, 3, 8, 4, 0, 43,
		42, 1, 0, 0, 0, 43, 44, 1, 0, 0, 0, 44, 5, 1, 0, 0, 0, 45, 46, 5, 10, 0,
		0, 46, 47, 5, 16, 0, 0, 47, 49, 5, 10, 0, 0, 48, 50, 5, 16, 0, 0, 49, 48,
		1, 0, 0, 0, 49, 50, 1, 0, 0, 0, 50, 51, 1, 0, 0, 0, 51, 53, 3, 12, 6, 0,
		52, 54, 5, 16, 0, 0, 53, 52, 1, 0, 0, 0, 53, 54, 1, 0, 0, 0, 54, 56, 1,
		0, 0, 0, 55, 57, 3, 10, 5, 0, 56, 55, 1, 0, 0, 0, 56, 57, 1, 0, 0, 0, 57,
		7, 1, 0, 0, 0, 58, 62, 5, 14, 0, 0, 59, 60, 5, 16, 0, 0, 60, 62, 4, 4,
		0, 1, 61, 58, 1, 0, 0, 0, 61, 59, 1, 0, 0, 0, 62, 9, 1, 0, 0, 0, 63, 65,
		5, 2, 0, 0, 64, 66, 5, 16, 0, 0, 65, 64, 1, 0, 0, 0, 65, 66, 1, 0, 0, 0,
		66, 67, 1, 0, 0, 0, 67, 69, 3, 4, 2, 0, 68, 70, 5, 16, 0, 0, 69, 68, 1,
		0, 0, 0, 69, 70, 1, 0, 0, 0, 70, 71, 1, 0, 0, 0, 71, 72, 5, 3, 0, 0, 72,
		11, 1, 0, 0, 0, 73, 75, 5, 4, 0, 0, 74, 76, 5, 16, 0, 0, 75, 74, 1, 0,
		0, 0, 75, 76, 1, 0, 0, 0, 76, 85, 1, 0, 0, 0, 77, 82, 3, 14, 7, 0, 78,
		79, 5, 15, 0, 0, 79, 81, 3, 14, 7, 0, 80, 78, 1, 0, 0, 0, 81, 84, 1, 0,
		0, 0, 82, 80, 1, 0, 0, 0, 82, 83, 1, 0, 0, 0, 83, 86, 1, 0, 0, 0, 84, 82,
		1, 0, 0, 0, 85, 77, 1, 0, 0, 0, 85, 86, 1, 0, 0, 0, 86, 88, 1, 0, 0, 0,
		87, 89, 5, 15, 0, 0, 88, 87, 1, 0, 0, 0, 88, 89, 1, 0, 0, 0, 89, 90, 1,
		0, 0, 0, 90, 91, 5, 5, 0, 0, 91, 13, 1, 0, 0, 0, 92, 94, 5, 10, 0, 0, 93,
		95, 5, 16, 0, 0, 94, 93, 1, 0, 0, 0, 94, 95, 1, 0, 0, 0, 95, 96, 1, 0,
		0, 0, 96, 98, 5, 6, 0, 0, 97, 99, 5, 16, 0, 0, 98, 97, 1, 0, 0, 0, 98,
		99, 1, 0, 0, 0, 99, 100, 1, 0, 0, 0, 100, 102, 3, 16, 8, 0, 101, 103, 5,
		16, 0, 0, 102, 101, 1, 0, 0, 0, 102, 103, 1, 0, 0, 0, 103, 15, 1, 0, 0,
		0, 104, 110, 5, 8, 0, 0, 105, 110, 5, 9, 0, 0, 106, 110, 5, 12, 0, 0, 107,
		110, 7, 0, 0, 0, 108, 110, 5, 7, 0, 0, 109, 104, 1, 0, 0, 0, 109, 105,
		1, 0, 0, 0, 109, 106, 1, 0, 0, 0, 109, 107, 1, 0, 0, 0, 109, 108, 1, 0,
		0, 0, 110, 17, 1, 0, 0, 0, 18, 19, 25, 39, 43, 49, 53, 56, 61, 65, 69,
		75, 82, 85, 88, 94, 98, 102, 109,
	}
...
const (
	...
	UIDLParserT__5               = 6
	UIDLParserBool               = 7
	UIDLParserDoubleQuotedString = 8
	UIDLParserBackQuotedString   = 9
	UIDLParserIdentifier         = 10
	UIDLParserNatural            = 11
	UIDLParserFloat              = 12
	UIDLParserInt                = 13
	UIDLParserSemicolon          = 14
	UIDLParserComma              = 15
	UIDLParserWhiteSpace         = 16
)
